# -*- coding: utf-8 -*-
"""
Created on Tue Jan 9 12:00:35 2023

@author: arzu.yildiz
"""

""" '#%%'Section 'lar kodları bölüm bölüm çalıştırmamıza yarar Section ın üzerinde Shift + Enter ile çalıştırabiliriz."""
#%% Lambda Fonksiyonu
"""
İleri seviye bir fonksiyon çeşididir.
Lambda fonksiyonu birçok girdi alabilir, ancak yalnızca bir ifadeye sahip olabilir. 
"""
...
dictionary = {"isim": ["arzu","gokhan","ali","eren","yigit efe","gizem"],
